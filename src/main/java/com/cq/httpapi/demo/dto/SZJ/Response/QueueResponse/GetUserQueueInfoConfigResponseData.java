...
public class GetUserQueueInfoConfigResponseData {
    ...
    public GetUserQueueInfoConfigResponseData(Szjqueueinfoconfig szjqueueinfoconfig) throws Exception {
        ObjectKit.deliverPropIgnoreCase(this, szjqueueinfoconfig);
    }
