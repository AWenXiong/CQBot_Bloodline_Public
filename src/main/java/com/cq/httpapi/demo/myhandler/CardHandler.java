...
//
//    public static void setCardService(CardService cardService1) {
...
//    @CQResponse
//    public static GroupMessageResponse grpHobbyChecker(MsgHttpReqHandler grpMsgHttpReqHandler){
//
...
//            reply.append(card.getFullname());
//            reply.append(" 技能\n");
//            reply.append("必杀：" + showProp(card.getSkill1()) + "\n");
//            reply.append("天赋：" + showProp(card.getSkill2()) + "\n");
//            reply.append("队长：" + showProp(card.getSkill3()) + "\n");
//            reply.append("命运：" + showProp(card.getSkill4()) + "\n");
//            response.setReply(reply.toString().trim());
//            response.setFlag(true);
//            return response;
//        }
...
//                reply.append("必杀技：" + showProp(card.getSkill1()) + "\n");
//                reply.append("天赋技：" + showProp(card.getSkill2()) + "\n");
//                reply.append("队长技：" + showProp(card.getSkill3()) + "\n");
//                reply.append("命运技：" + showProp(card.getSkill4()) + "\n");
//                reply.append("命运链接：" + showProp(card.getPartner()) + "\n");
...
//    @CQResponse
//    public static PrivateMessageResponse priHobbyChecker(MsgHttpReqHandler priMsgHttpReqHandler){
//
...
//    }
    ...
    // 对卡牌表进行查
    @CQResponse
//    public static MessageResponse cardChecker(MsgHttpReqHandler msgHttpReqHandler) {
